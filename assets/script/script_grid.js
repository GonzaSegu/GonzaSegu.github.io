const hamburguesa = document.getElementById('burguer');
const menuFalso = document.getElementById('menuFalso');
const menu = document.getElementById('menu');
const foto_team = document.getElementById('team');
const foto_servicios = document.getElementById('foto_servicios');
